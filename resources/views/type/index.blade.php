...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Categoria de tiendas</h1>
...
<div class="card">
                <div class="card-header">Lista de categorias de tiendas</div>
...
<div class="modal fade" id="ModalAdd" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Agregar Categoria de tienda</h5>
  ...
  <div class="form-group">
    ...
    <small id="emailHelp" class="form-text text-muted">Digita el nombre de la categotia</small>
  </div>
...
<div class="modal fade" id="ModalEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <label for="exampleFormControlFile1">Imagen</label>
  <div class="form-group">
    <input type="file" class="form-control-file" id="file_logo_edit" required="true">
  </div>
      </div>
...
<div class="modal fade" id="ModalDelete" tabindex="-1" role="dialog"  aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form id="form_delete">
      <div class="modal-body">
        <h3>¿Deseas eliminar esta categoria de tienda? se eliminara todo lo asociado a esto.</h3>
      </div>
